#!/bin/bash
# Compile the ice-skaters JSS paper.
...
echo "Compiling ice-skaters-jss.tex with Tectonic..."
tectonic ice-skaters-jss.tex

echo "Cleaning up auxiliary files..."
rm -f *.aux *.log *.bbl *.blg *.out *.toc *.lot *.lof

echo "Done: ice-skaters-jss.pdf"
if [[ "$OSTYPE" == "darwin"* ]]; then
    open ice-skaters-jss.pdf
fi
